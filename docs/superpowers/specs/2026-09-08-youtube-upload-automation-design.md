...
`docs/remotion_사이드트랙_프로젝트설정.md`의 1차 스코프는 "배포는 1차에서 수동 업로드만
지원한다... 업로드 API 연동은 하지 않는다"(스펙 §8, `2026-08-15-motionlab-remotion-pipeline.md`
plan 참고)였다. 003~006 4편이 쌓인 시점에 매 편 수동 업로드가 반복 작업이 되어 이 결정을
